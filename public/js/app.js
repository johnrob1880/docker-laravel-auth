...
var VueCookie = __webpack_require__(42);
window.Vue.use(VueCookie);

var VueCurrencyFilter = __webpack_require__(44);
...
window.omegaquant = {
    ...
    submitForm: function submitForm(target, htmlId, formId, forceWidth) {
...
window.omegaquant = {
    ...
    submitForm: function submitForm(target, htmlId, formId) {
